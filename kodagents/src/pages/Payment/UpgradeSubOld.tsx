...
const UpgradeAndPayment: React.FC = () => {
  ...
  // const handlePaystackSubscription = async (e: React.FormEvent<HTMLFormElement>) => {
  //   e.preventDefault();
  //   setLoading(true);
  //   setError(null);
  //   console.log('Attempting to submit Paystack subscription');
  ...
  //       payment_type: 'subscription'
  //     });
  //     console.log('Subscription initiation response:', response.data);
      ...
      <main className="flex-grow flex justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
          ...
          {/* {paymentMethod === 'paystack' ? (
            <form className="space-y-4" onSubmit={handlePaystackSubscription}>
              <div>
                <button
                  type="submit"
                  disabled={loading}
