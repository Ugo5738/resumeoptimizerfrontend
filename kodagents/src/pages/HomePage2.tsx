        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Kodagents is redefining the future of work with groundbreaking
              AI-driven solutions. As the first entirely AI-operated agency, we
              deploy specialized agents to revolutionize workflows, skyrocket
              productivity, and create unparalleled opportunities for
